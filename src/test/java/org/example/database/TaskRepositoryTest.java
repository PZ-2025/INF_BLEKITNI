...
class TaskRepositoryTest {
    ...
    static void setup() throws Exception {
        ...
        zad1 = new Task("Przyjęcie dostawy", d1, "Nowe", "Przyjąć dostawę mleka.", "Duży", LocalTime.of(2, 30));
        zad2 = new Task("Sprawdzenie stanów", d2, "Nowe", "Sprawdzić ilość jogurtów.", "Średni", LocalTime.of(1, 0));
        zad3 = new Task("Aktualizacja cen",  d3, "W trakcie", "Aktualizacja cen nabiału.", "Duży", null);
